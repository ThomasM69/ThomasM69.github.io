var size = 0;
var placement = 'point';
function categories_FaitsAntique_9(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
...
case 'élément de circulation':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(175,195,205,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement)
    })];
                    break;
...
var style_FaitsAntique_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_FaitsAntique_9(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
