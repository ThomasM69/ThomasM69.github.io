var size = 0;
var placement = 'point';
function categories_ElmentsrestitusAntique_8(feature, value, size, resolution, labelText,
                       labelFont, labelFill) {
                switch(value.toString()) {case 'Agricole':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(100,100,100,0.960784)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(131,242,66,0.719646054902)'}),
...
case 'Hydraulique':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(160,208,247,0.749019607843)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement)
    })];
                    break;
...
var style_ElmentsrestitusAntique_8 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_ElmentsrestitusAntique_8(feature, value, size, resolution, labelText,
                          labelFont, labelFill);
